...
```erlang
1.0 = graphics_color:red(C).
0.0 = graphics_color:green(C).
0.0 = graphics_color:blue(C).
1.0 = graphics_color:alpha(C).
```
...
```erlang
{1.0, 0.0, 0.0, 1.0} = graphics_color:from_bytes(255, 0, 0).
...
```erlang
{1.0, 0.0, 0.0, 0.5} = graphics_color:rgba(1.0, 0.0, 0.0, 0.5).
```
""".
...
```erlang
{1.0, 0.0, 0.0, 1.0} = graphics_color:from_bytes(255, 0, 0, 255).
```
""".
...
```erlang
{1.0, 0.0, 0.0, 1.0} = graphics_color:from_integer(16#FF0000FF).
```
""".
...
```erlang
16#FF0000FF = graphics_color:to_integer({1.0, 0.0, 0.0, 1.0}).
```
""".
