...
default_program_uniforms_test() ->
    ...
    true = program:has_uniform(Program, "uModel"),
    true = program:has_uniform(Program, "uView"),
    true = program:has_uniform(Program, "uProjection"),
    true = program:has_uniform(Program, "uTexture"),
    true = program:has_uniform(Program, "uUseTexture"),
